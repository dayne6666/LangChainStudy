...
response_schema={
        ...
        "properties": {
            ...
            "customer_tier": {"type": "string", "default":"","description": "客户等级"},
            "spending_level": {"type": "string","default":"","description": "消费水平"},
            "send_email": {"type": "boolean","default":False,"description": "是否已发送感谢邮件"}
        },
        "required": ["customer_name", "customer_tier", "spending_level", "send_email"]
    }
